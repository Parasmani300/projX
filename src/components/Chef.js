        ...
        <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100" >
          <div className="chef-member">
            <div className="member-img">
              <img src="https://media.30seconds.com/tip/lg/Knife-Tips-From-Chefs-3-Ways-to-Save-Your-Knives-While-Coo-22573-0c873fd071-1619459903.jpg" className="img-fluid" alt="" />
